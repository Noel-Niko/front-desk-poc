...
class TestStripMarkdown:
    ...
    def test_removes_links(self):
        ...
        assert (
            strip_markdown("Visit [our site](https://example.com) today")
    ...
    def test_removes_inline_code(self):
        ...
        assert (
            strip_markdown("Use `pip install` to install")
...
class TestCartesiaTTSService:
    ...
    async def test_read_response_passes_speed_param(self):
        ...
        assert call_kwargs.kwargs.get("speed") == "fast" or (
            len(call_kwargs.args) > 1 and call_kwargs.args[1] == "fast"
        )
